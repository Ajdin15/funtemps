...
func init() {
	...
	*/
	...
	flag.Float64Var(&fahr, "F", 0, "temperatur i grader fahrenheit")
      flag.Float64Var(&cel, "C", 0, "temperatur i grader celsius")
      flag.Float64Var(&kel, "K", 0, "temperatur i grader kelvin")	
